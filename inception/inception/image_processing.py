...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=None,
  ...
  with tf.name_scope('batch_processing'):
    ...
    for thread_id in range(num_preprocess_threads):
      ...
      image_buffer, label_index, bbox, _, filename_text = parse_example_proto(                 # here
          example_serialized)
      image = image_preprocessing(image_buffer, bbox, train, thread_id)
      images_and_labels.append([image, label_index, filename_text])
    ...
    return images, tf.reshape(label_index_batch, [batch_size]), tf.reshape(filename_batch, [batch_size])
